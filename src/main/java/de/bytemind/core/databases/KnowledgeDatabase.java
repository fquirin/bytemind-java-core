...
/**
 * Interface for databases that are used to store knowledge like document data or larger user data. 
 * First and foremost this is meant to be an interface for Elasticsearch (and not DynamoDB, but feel free ...).
 * 
 * @author Florian Quirin
 *
 */
public interface KnowledgeDatabase {
	 ...
	 * @return JSON with error code indicating success (0) or different errors (1 - database not reached) etc. ...
	 */
