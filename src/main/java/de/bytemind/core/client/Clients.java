...
public class Clients {
	...
	//TODO: this class needs some rework I think :-#
	
	//this is somewhat identical with ENVIRONMENTS but we keep it anyway ^^
	final public static String API_SERVER = "server";			//e.g. Basic micro-service
	...
	/**
	 * Check for client by comparing the input (this_env) to an array of
	 * test environments (test_envies). E.g. you want to check for a web app running on iOS use:
	 * compare(this_env, Clients.WEB_APP, Clients.IOS_BROWSER).
	 * 
