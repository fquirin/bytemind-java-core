...
/**
 * Security policy that distinguishes between the system default class loader and "SandboxClassLoader". For the latter one can set
 * the permissions in "sandboxPersmissions", currently it has only "SocketPermission" to user HTTP REST calls. 
 * 
